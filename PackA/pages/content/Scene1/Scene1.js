...
Page({
  ...
  data: {
    ...
    backgroundImage: 'https://636c-cloud1-4gl4jj9w3cb8d273-1311875883.tcb.qcloud.la/Image/Scene1/Scene1.jpg?sign=39048fb07990c017f19b599b74ddbd04&t=1652665236',
    article: [
      {
        id: 0, name: '乍至',
        ImageList: [
          'https://636c-cloud1-4gl4jj9w3cb8d273-1311875883.tcb.qcloud.la/Image/Scene1/Scene1.jpg?sign=39048fb07990c017f19b599b74ddbd04&t=1652665236'
        ],
        content: [
    ...
    pop: {
      ...
      options: [
        ...
        { id: 3, text: '采购租借', url: '/PackA/pages/content/Scene1/Scene1_4/Scene1_4' }
      ]
    },
    progress: {
      cur: 0,
...
nextScene(){ // 乍至
  ...
  console.log(gamelog)
  console.log(this.data.gamelog.Arttack.rearServiceGroup.arrival)
  gamelog.Arttack.rearServiceGroup.arrival=true
